    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MovieList movies={movies} onHandleSelectedId={handleSelectMovie} />
          )}
...
function MovieDetails({
  ...
  useEffect(
    function () {
      ...
      /// "Clean up function" Closure function : remember the variable of the main function
      return function () {
        ...
        <>
          <header>
            ...
            <div className="details-overview">
              <h2>{title}</h2>
              <p>
                <span>🎬</span> {released} &bull; {runtime}
              </p>
              <p>
                <span>💎</span> {genre}
              </p>
              ...
              {!isWatched ? (
                <>
                  <StarRating
                    maxRating={10}
                    size={24}
                    onSetRatingMovie={setUserRating}
                  />
                  {userRating > 0 && (
                ...
                <p>
                  you rated this movie <strong>{ratingUser}</strong>{" "}
                  <span>🌟</span>
                </p>
              )}
            </div>
...
function WatchedSummary({ watched = [] }) {
  if (!Array.isArray(watched)) return null;
